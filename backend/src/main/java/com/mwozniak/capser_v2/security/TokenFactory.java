...
public class TokenFactory {
    ...
    public static String generateAuthToken(UUID id, String role, String email, JwtConfiguration jwtConfiguration) throws IOException {
        ...
        return Jwts.builder().setSubject(id.toString()).claim("rol", role).claim("email", email).setIssuer(jwtIssuer)
