                ...
                <div style={{height: 71, display: "flex", flexDirection: "column", justifyContent: flexType}}>
                    <div
                        ...
                        <div className={[entryStyle.border, entryStyle.padding].join(' ')}
                            ...
                            {bracketEntry.player1 && <PlayerTooltip playerId={bracketEntry.player1.id} gameType={gameType}>
                        ...
                        <div className={entryStyle.padding}>
                            {bracketEntry.player2 &&
                            <PlayerTooltip playerId={bracketEntry.player2.id} gameType={gameType}>
                                <div style={{display: "flex", flexDirection: "row"}}>
                                    <Typography style={{
                                        flex: 1,
